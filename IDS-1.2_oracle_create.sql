...
-- REVOKE ALL ON Osoba FROM xmorku03;
-- REVOKE ALL ON Zakaznik FROM xmorku03;
-- REVOKE ALL ON Zames FROM xmorku03;
-- REVOKE ALL ON Pokladna FROM xmorku03;
-- REVOKE ALL ON Zbozi FROM xmorku03;
-- REVOKE ALL ON Objednavka FROM xmorku03;
-- REVOKE ALL ON Faktura FROM xmorku03;
-- REVOKE ALL ON malo_kontaktu_log FROM xmorku03;
-- REVOKE ALL ON Nepovolena_objednavka_log FROM xmorku03;
-- REVOKE ALL ON PREHLED_ZAM FROM xmorku03;
