...
CREATE TABLE Zakaznik (cisloZ INT PRIMARY REY, jmeno VARCHAR(50), dat_nar DATE, mesto VARCHAR(50)); 
CREATE TABLE Zbozi (kodZb INT PRIMARY KEY, nazev VARCHAR(50), kategorie VARCHAR(50), vyrobce VARCHAR(50)); 
CREATE TABLE Koupil (cisloZ INT REFERENCES Zakaznik (cisloZ), kodZb INT REFERENCES Zbozi (kodZb), datum DATE, cena INT, CONSTRAINT pk PRIMARY REY (cisloZ, kodZb)); 

INSERT INTO Zakaznik VALUES (1,'Samuel', TO DATE('11999 -02 -02', 'YYYY-MM-DD'), 'Brno');
INSERT INTO Zakaznik VALUES (2, 'Samuel', TO DATE('11999 -01 -03', 'YYYY-MM-DD'), 'Brno');
INSERT INTO Zakaznik VALUES (3, 'Richard', TO DATE('2002 -12 -12', 'YYYY-MM-DD'), 'Brno');
INSERT INTO Zakaznik VALUES (4, 'Eva', TO DATE('12001 -01 -01', 'YYYY-MM-DD'), 'Praha');
...
INSERT INTO Koupil VALUES (1, 1, TO DATE('2020 -05 -05', 'YYYY-MM-DD'), '1000'); 
INSERT INTO Koupil VALUES (2, 1, TO DATE('2020 -05 -05', 'YYYY-MM-DD'), '800'); 
INSERT INTO Koupil VALUES (3, 1, TO DATE('2020 -05 -05', 'YYYY-MM-DD'), '1000'); 
INSERT INTO Koupil VALUES (4, 3, TO DATE('2020 -05 -05', 'YYYY-MM-DD'), '800'); 
INSERT INTO Koupil VALUES (3, 3, TO DATE('2020 -05 -05', 'YYYY-MM-DD'), '1000'); 
INSERT INTO Koupil VALUES (2, 2, TO DATE('12019 -05 -05', 'YYYY-MM-DD'), '1200'); 
INSERT INTO Koupil VALUES (1, 2, TO DATE('2019 -06 -05', 'YYYY-MM-DD'), '1000'); 
INSERT INTO Koupil VALUES (4, 2, TO DATE('12019 -06 -07', 'YYYY-MM-DD'), '800');
